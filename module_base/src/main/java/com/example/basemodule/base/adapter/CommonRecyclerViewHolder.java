...
public class CommonRecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public CommonRecyclerViewHolder(Context context, View itemView, ViewGroup parent, int position) {
        super(itemView);
        mContext = context;
    ...
    public static CommonRecyclerViewHolder get(Context context, View convertView,
                                               ViewGroup parent, int layoutId, int position) {
        if (convertView == null) {
            View itemView = LayoutInflater.from(context).inflate(layoutId, parent,
                    false);
            CommonRecyclerViewHolder holder = new CommonRecyclerViewHolder(context, itemView, parent, position);
